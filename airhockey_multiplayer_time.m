...
figure('units','normalized','outerposition',[0 0 1 1],'WindowStyle','modal');
    ...
    %scaled values from wiimote input
    awii=0;
    bwii=0;
    cwii=0;
    scaling=8000;
...
%     scoreboard
    ...
    while ~isButtonPressed('B');
        ...
        if time_elapsed>120
%            title('Game Over!')
           text(-11000,5000,'Go again or polish your skills against the clock!','fontname','Kristen ITC','fontsize',40,'color',[0 0 1]);              
...
%         bound strikers
        ...
        top_text2=char('Score1: ',score_string);
        mytitle=title(top_text,'fontsize', 28,'position',[-5000,2000],'color','b','fontname','Kristen ITC');
